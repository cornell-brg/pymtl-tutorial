...
\end{itemize}
  ...
  \begin{cbxcols}
  \begin{column}{0.3\tw}
  \cbxfigc[.9\tw]{poster-tile.svg.pdf}
  \end{column}
  ...
  \begin{column}{0.3\tw}
  \cbxfigc[\tw]{tile-amoeba-small-invert.jpg}
  \end{column}
  \end{cbxcols}
...
\begin{itemize}
  ...
  {\tiny\IT{Srinath, Ilbeyi, et. al. ``Architectural Specialization for
  Inter-Iteration Loop Dependence Patterns.'' 47th ACM/IEEE Int'l Symp. on
