...
\begin{cbxlist}
  \1 Task 1.1: Experiment with \TT{Bits}
...
\begin{frame}{\IT{Hands-On:} PyMTL Basics with Max/RegIncr}
\begin{cbxlist}
  \1 \BF{Task 1.1: Experiment with \TT{Bits}}
  \1 \BF{Task 1.2: Interactively simulate a max unit}
  \1 Task 1.3: Write a registered incrementer (RegIncr) model
  \1 Task 1.4: Test the RegIncr model
  \1 Task 1.5: Translate the RegIncr model into Verilog
  \1 Task 1.6: Simulate the RegIncr model with line tracing
...
\begin{cbxlist}
  \1 Task 1.1: Experiment with \TT{Bits}
  \1 Task 1.2: Interactively simulate a max unit
  \1 \BF{Task 1.3: Write a registered incrementer (RegIncr) model}
  \1 \BF{Task 1.4: Test the RegIncr model}
  \1 \BF{Task 1.5: Translate the RegIncr model into Verilog}
  \1 Task 1.6: Simulate the RegIncr model with line tracing
  \1 Task 1.7: Simulate the RegIncr model with VCD dumping
  \1 Task 1.8: Compose a pipeline with two RegIncr models
  \1 Task 1.9: Compose a pipeline with N RegIncr models
...
\begin{cbxlist}
  ...
  \1 Task 1.4: Test the RegIncr model
  \1 Task 1.5: Translate the RegIncr model into Verilog
  \1 \BF{Task 1.6: Simulate the RegIncr model with line tracing}
  \1 \BF{Task 1.7: Simulate the RegIncr model with VCD dumping}
  \1 Task 1.8: Compose a pipeline with two RegIncr models
  \1 Task 1.9: Compose a pipeline with N RegIncr models
  \1 Task 1.10: Parameterize test to verify multiple Ns
\end{cbxlist}
...
\begin{cbxlist}
  ...
  \1 Task 1.6: Simulate the RegIncr model with line tracing
  \1 Task 1.7: Simulate the RegIncr model with VCD dumping
  \1 \BF{Task 1.8: Compose a pipeline with two RegIncr models}
  \1 \BF{Task 1.9: Compose a pipeline with N RegIncr models}
  \1 \BF{Task 1.10: Parameterize test to verify multiple Ns}
\end{cbxlist}
\end{frame}
...
\lstinputlisting[xleftmargin={0.38in},firstline=9,lastline=18,firstnumber=9]%
