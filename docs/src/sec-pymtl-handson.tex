...
\end{verbatim}
\lstinputlisting[firstline=8,lastline=22]{../../regincr_soln/RegIncrRTL.py}
\begin{verbatim}
  % py.test ../regincr/RegIncrRTL_test.py --verbose
\end{verbatim}
...
%-------------------------------------------------------------------------
\begin{task}\begin{frame}[fragile]{Add Verilog translation to test harness.}
%-------------------------------------------------------------------------
...
\lstinputlisting[firstline=20,lastline=29]{../../regincr_soln/RegIncrRTL_test.py}
...
\lstinputlisting[firstline=1,lastline=29]%
