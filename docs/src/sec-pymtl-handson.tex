...
\vspace{-0.3in}
\lstinputlisting[xleftmargin={0.38in},firstline=8,lastline=22]%
...
%-------------------------------------------------------------------------
\vspace{0.3in}
\cbxfigc<1>{../images/pymtl-tut-simjit0.pdf}
\cbxfigc<2>{../images/pymtl-tut-simjit1.pdf}
\end{frame}
...
\vspace{-0.3in}
\lstinputlisting[xleftmargin={0.38in},firstline=4,lastline=16]%
...
\vspace{-0.3in}
\lstinputlisting[xleftmargin={0.38in},firstline=9,lastline=17]%
...
\vspace{-0.3in}
\lstinputlisting[xleftmargin={0.38in},firstline=9,lastline=20]%
...
%-------------------------------------------------------------------------
\begin{task}\begin{frame}[fragile]{Update test to verify multiple Ns}
%-------------------------------------------------------------------------
\vspace{-0.25in}
\begin{verbatim}
  % cd    ~/pymtl-tutorial/build
...
\vspace{-0.3in}
\lstinputlisting[xleftmargin={0.38in},firstline=46,lastline=51]%
