...
\name      {PyMTL: A Unified Framework for Vertically Integrated Computer Architecture Research}
\abbrvinst {UCSD 2016}
...
\begin{itemize}
  \item See the detailed tutorials on the Cornell ECE 4750 website:
        \TT{http://www.csl.cornell.edu/courses/ece4750/handouts}
\end{itemize}
...
\begin{itemize}
  \item \TT{https://github.com/cornell-brg/pymtl}
  \item \TT{https://github.com/cornell-brg/pydgin}
\end{itemize}
\end{frame}
