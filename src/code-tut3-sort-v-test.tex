...
\end{lstlisting}
  ...
  \caption{\textbf{Unit Test Script for Sort Model with Verilog
      Translation --} The \TT{test_verilog} argument is handled specially
    by the PyMTL framework; it is set to \TT{True} when the
    \TT{-{}-test-verilog} command line option is given to \TT{py.test}.}
